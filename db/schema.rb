...
ActiveRecord::Schema[7.2].define(version: 2024_08_24_005835) do
  create_table "job_required_skills", force: :cascade do |t|
    t.string "required_skill"
    t.integer "job_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["job_id"], name: "index_job_required_skills_on_job_id"
  end
  ...
  add_foreign_key "job_required_skills", "jobs"
